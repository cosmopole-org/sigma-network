...
func (s *ToolboxL2) Chain() *tool_chain.DLedger {
	return s.chain
}
...
func NewTools(core abstract.ICore, logger *modulelogger.Logger, storageRoot string, storage adapters.IStorage, cache adapters.ICache, file *toolfile.File, chain *tool_chain.DLedger) *ToolboxL2 {

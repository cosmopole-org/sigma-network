...
const Loading = (props: { onCancel: () => void, overlay?: boolean, isWidget?: boolean }) => {
    return (
        <div style={{ width: '100%', height: '100%', position: 'fixed', left: 0, top: 0 }}>
            {
                props.overlay ? (
                    <Card style={{ position: 'absolute', left: '50%', top: 'calc(50% - 16px)', transform: 'translate(-50%, -50%)', borderRadius: 24, backgroundColor: colors.blue[100] }}>
                        {
                            props.isWidget ? (
                                <div style={{ width: 'auto', height: 'auto', position: 'relative', padding: 32 }}>
                                    <Card style={{ width: 56, height: 56, borderRadius: '50%', position: 'absolute', left: '50%', transform: 'translateX(-50%)' }}>
                                ...
                                <div style={{ width: 'auto', height: 'auto', position: 'relative', padding: 32 }}>
                                    ...
                                    <p style={{ width: '100%', textAlign: 'center', marginTop: 12 }}>
                                        Loading Applet...
                                    </p>
                                    <Button
                                        style={{ marginTop: 32 }}

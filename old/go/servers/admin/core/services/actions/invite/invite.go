...
import (
	"errors"
	"fmt"
	inputs_invites "sigma/admin/core/inputs/invites"
...
func (a *InviteActions) Create(control *runtime.Control, input inputs_invites.CreateInput, info models.Info) (any, error) {
...
func (a *InviteActions) Cancel(control *runtime.Control, input inputs_invites.CancelInput, info models.Info) (any, error) {
...
func (a *InviteActions) Accept(control *runtime.Control, input inputs_invites.AcceptInput, info models.Info) (any, error) {
	invite := models.Invite{Id: input.InviteId}
...
func (a *InviteActions) Decline(control *runtime.Control, input inputs_invites.DeclineInput, info models.Info) (any, error) {
	invite := models.Invite{Id: input.InviteId}
	err := control.Trx.First(&invite).Error()
	if err != nil {
		return nil, err

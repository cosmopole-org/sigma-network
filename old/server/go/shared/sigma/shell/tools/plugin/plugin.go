...
func (wm *PluginsTool) Plug(wasmFilePath string, meta []runtime.PluginFunction) {
...
func (wm *PluginsTool) loadWasmModules() {
...
func New(sc *layer1_app.App, netTool *network_manager.NetManager) *PluginsTool {
	wm := &PluginsTool{
		netTool:     netTool,

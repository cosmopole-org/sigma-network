...
func createInvite(app *interfaces.IApp, dto interfaces.IDto, assistant interfaces.IAssistant) (any, error) {
...
func cancelInvite(app *interfaces.IApp, dto interfaces.IDto, assistant interfaces.IAssistant) (any, error) {
...
func acceptInvite(app *interfaces.IApp, dto interfaces.IDto, assistant interfaces.IAssistant) (any, error) {
...
func declineInvite(app *interfaces.IApp, dto interfaces.IDto, assistant interfaces.IAssistant) (any, error) {
...
func CreateInviteService(app *interfaces.IApp) interfaces.IService {
	...
	return types.CreateService(app, "invites").
		AddMethod(types.CreateMethod("create", createInvite, types.CreateCheck(true, true, false), &dtos_invites.CreateDto{}, true, false)).
		AddMethod(types.CreateMethod("cancel", cancelInvite, types.CreateCheck(true, true, false), &dtos_invites.CancelDto{}, true, false)).
		AddMethod(types.CreateMethod("accept", acceptInvite, types.CreateCheck(true, false, false), &dtos_invites.AcceptDto{}, true, false)).
		AddMethod(types.CreateMethod("decline", declineInvite, types.CreateCheck(true, false, false), &dtos_invites.DeclineDto{}, true, false))
}

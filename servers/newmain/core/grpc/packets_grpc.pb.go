...
type AuthServiceClient interface {
	GetServerPublicKey(ctx context.Context, in *AuthGetServerPublicKeyDto, opts ...grpc.CallOption) (*AuthGetServerPublicKeyOutput, error)
}
...
func (c *authServiceClient) GetServerPublicKey(ctx context.Context, in *AuthGetServerPublicKeyDto, opts ...grpc.CallOption) (*AuthGetServerPublicKeyOutput, error) {
	out := new(AuthGetServerPublicKeyOutput)
	err := c.cc.Invoke(ctx, "/sigma.AuthService/getServerPublicKey", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AuthServiceServer interface {
	GetServerPublicKey(context.Context, *AuthGetServerPublicKeyDto) (*AuthGetServerPublicKeyOutput, error)
...
func (UnimplementedAuthServiceServer) GetServerPublicKey(context.Context, *AuthGetServerPublicKeyDto) (*AuthGetServerPublicKeyOutput, error) {
...
func _AuthService_GetServerPublicKey_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(AuthGetServerPublicKeyDto)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AuthServiceServer).GetServerPublicKey(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/sigma.AuthService/getServerPublicKey",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServiceServer).GetServerPublicKey(ctx, req.(*AuthGetServerPublicKeyDto))
	}
	return interceptor(ctx, in, info, handler)
}
...
var AuthService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "sigma.AuthService",
	HandlerType: (*AuthServiceServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "getServerPublicKey",
			Handler:    _AuthService_GetServerPublicKey_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "packets.proto",

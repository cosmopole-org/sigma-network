...
class GridGalleryState extends State<GridGallery>
  ...
  Offset calculateItemCoordinate(int itemIndex) {
    ...
    double horizontal = (itemIndex % widget.crossAxisCount).toDouble();

    debugPrint('$horizontal $vertical');
  ...
  void startItemDragging({
    ...
    required DelayedMultiDragGestureRecognizer recognizer,
  }) {

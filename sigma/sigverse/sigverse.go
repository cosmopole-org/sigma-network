		...
		import (
			...
			plugger_dummy2 "sigma/main/sigverse/pluggers/dummy2"
			action_dummy2 "sigma/main/sigverse/actions/dummy2"
		...
		func PlugAll(layer abstract.ILayer) {
				...
				PlugThePlugger(layer, plugger_dummy2.New(&action_dummy2.Actions{Layer: layer}))

    ...
    function transfer(document, mutation) {
      if (phase > 0 /* Initializing */ && document[58 /* allowTransfer */]) {
        ...
        Promise.resolve().then(_ => {
          if (pending) {
            const nodes = new Uint16Array(consume$1().reduce((acc, node) => acc.concat(node[8 /* creationFormat */]), [])).buffer;
    ...
    */
    ...
    class Element extends ParentNode {
      constructor(nodeType, localName, namespaceURI, ownerDocument, overrideIndex) {
        ...
        this[8 /* creationFormat */] = [this[7 /* index */], this.nodeType, store(this.localName), 0, this.namespaceURI === null ? 0 : store(this.namespaceURI)];
      }
    ...
    */
    ...
    class CanvasGradient {
      ...
      addColorStop(offset, color) {
        transfer(this.document, [9 /* OBJECT_MUTATION */, store('addColorStop'), 2, ...this[68 /* serializeAsTransferrableObject */](), ...serializeTransferrableObject([...arguments])]);
      }
      [68 /* serializeAsTransferrableObject */]() {
    ...
    class OffscreenCanvasRenderingContext2DPolyfill {
      ...
      [67 /* mutated */](fnName, args) {
        transfer(this.canvasElement.ownerDocument, [9 /* OBJECT_MUTATION */, store(fnName), args.length, ...this[68 /* serializeAsTransferrableObject */](), ...serializeTransferrableObject(args)]);
      }
      [68 /* serializeAsTransferrableObject */]() {
      ...
      createObjectReference(objectId, creationMethod, creationArgs) {
        transfer(this.canvasElement.ownerDocument, [10 /* OBJECT_CREATION */, store(creationMethod), objectId, creationArgs.length, ...this[68 /* serializeAsTransferrableObject */](), ...serializeTransferrableObject(creationArgs)]);
      }
      get canvas() {
    ...
    */
    ...
    class CharacterData extends Node {
      constructor(data, nodeType, nodeName, ownerDocument, overrideIndex) {
        ...
        this[38 /* data */] = void 0;
        this[38 /* data */] = data;
        this[8 /* creationFormat */] = [this[7 /* index */], nodeType, store(nodeName), store(data), 0];
      }
      // Unimplemented Methods
    ...
    class DocumentFragment extends ParentNode {
      constructor(ownerDocument, overrideIndex) {
        ...
        this[8 /* creationFormat */] = [this[7 /* index */], 11 /* DOCUMENT_FRAGMENT_NODE */, store(this.nodeName), 0, 0];
      }
      /**
       * @param deep boolean determines if the clone should include a recursive copy of all childNodes.

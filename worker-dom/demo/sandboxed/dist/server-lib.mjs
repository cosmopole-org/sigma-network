...
class Node {
  ...
  removeEventListener(type, handler) {
    ...
    if (index >= 0) {
      ...
      transfer(this.ownerDocument, [4 /* EVENT_SUBSCRIPTION */, this[7 /* index */], 1, 0, store(), index]);
    }
  }
  /**
...
class DOMTokenList {
  ...
  [67 /* mutated */](oldValue, value) {
    ...
    mutate(this[13 /* target */].ownerDocument, {
      ...
      value,
      oldValue
    }, [0 /* ATTRIBUTES */, this[13 /* target */][7 /* index */], store(this[18 /* attributeName */]), 0, value !== null ? store() + 1 : 0]);
  }
}
...
class CSSStyleDeclaration {
  ...
  mutated(value) {
    ...
    mutate(this[13 /* target */].ownerDocument, {
      ...
      value,
      oldValue
    }, [0 /* ATTRIBUTES */, this[13 /* target */][7 /* index */], store(), 0, value !== null ? store() + 1 : 0]);
  }
}
...
class Element extends ParentNode {
  ...
  setAttributeNS(namespaceURI, name, value) {
    ...
    mutate(this.ownerDocument, {
      ...
      value: valueAsString,
      oldValue
    }, [0 /* ATTRIBUTES */, this[7 /* index */], store(), store(), value !== null ? store() + 1 : 0]);
  }
  ...
  removeAttributeNS(namespaceURI, name) {
    ...
    if (index >= 0) {
      ...
      mutate(this.ownerDocument, {
        ...
        attributeNamespace: namespaceURI,
        oldValue
      }, [0 /* ATTRIBUTES */, this[7 /* index */], store(), store(), 0 // 0 means no value
      ]);
    }
  }
  /**
...
function serializeTransferrableObject(args) {
  ...
  for (let i = 0; i < args.length; i++) {
    ...
    if (typeof arg === 'string') {
      serialized.push(3 /* String */, store());
      continue;
    }
...
class CanvasGradient {
  ...
  addColorStop(offset, color) {
    transfer(this.document, [9 /* OBJECT_MUTATION */, store(), 2, ...this[68 /* serializeAsTransferrableObject */](), ...serializeTransferrableObject([...arguments])]);
  }
  [68 /* serializeAsTransferrableObject */]() {
...
class OffscreenCanvasRenderingContext2DPolyfill {
  ...
  [67 /* mutated */](fnName, args) {
    transfer(this.canvasElement.ownerDocument, [9 /* OBJECT_MUTATION */, store(), args.length, ...this[68 /* serializeAsTransferrableObject */](), ...serializeTransferrableObject(args)]);
  }
  [68 /* serializeAsTransferrableObject */]() {
  ...
  createObjectReference(objectId, creationMethod, creationArgs) {
    transfer(this.canvasElement.ownerDocument, [10 /* OBJECT_CREATION */, store(), objectId, creationArgs.length, ...this[68 /* serializeAsTransferrableObject */](), ...serializeTransferrableObject(creationArgs)]);
  }
  get canvas() {
...
class HTMLInputElement extends HTMLElement {
  ...
  set value(value) {
    ...
    transfer(this.ownerDocument, [3 /* PROPERTIES */, this[7 /* index */], store(), 0 /* FALSE */, store()]);
  }
  get valueAsDate() {
  ...
  set checked(value) {
    ...
    transfer(this.ownerDocument, [3 /* PROPERTIES */, this[7 /* index */], store(), 1 /* TRUE */, value === true ? 1 /* TRUE */ : 0 /* FALSE */]);
  }
  /**
...
class HTMLOptionElement extends HTMLElement {
  ...
  set selected(value) {
    ...
    transfer(this.ownerDocument, [3 /* PROPERTIES */, this[7 /* index */], store(), 1 /* TRUE */, this[52 /* selected */] ? 1 /* TRUE */ : 0 /* FALSE */]);
  }
  /**
   * A Synonym for the Node.textContent property getter.
   * @see https://developer.mozilla.org/en-US/docs/Web/API/HTMLOptionElement
...
class CharacterData extends Node {
  constructor(data, nodeType, nodeName, ownerDocument, overrideIndex) {
    ...
    this[38 /* data */] = void 0;
    this[38 /* data */] = data;
    this[8 /* creationFormat */] = [this[7 /* index */], nodeType, store(), store(), 0];
  }
  // Unimplemented Methods
  ...
  set data(value) {
    ...
    mutate(this.ownerDocument, {
      ...
      value,
      oldValue
    }, [1 /* CHARACTER_DATA */, this[7 /* index */], store()]);
  }
  /**

var WorkerThread = (function (exports) {
    ...
    return _createClass(AMP, [{
      ...
      value: function getState() {
        ...
        return new Promise(function (resolve) {
          ...
          transfer(_this.document, [12 /* STORAGE */, 1 /* GET */, 2 /* AmpState */, /* key */store(key) + 1, /* value */0]);
      ...
      value: function setState(state) {
        ...
        transfer(this.document, [12 /* STORAGE */, 2 /* SET */, 2 /* AmpState */, /* key */0, /* value */store(stringified) + 1]);
      }
    }]);
  }();
  ...
  function callFunctionMessageHandler(event, document) {
    ...
    if (!fn) {
      transfer(document, [13 /* FUNCTION_CALL */, 2 /* REJECT */, index, store(JSON.stringify("[worker-dom]: Exported function \"".concat(fnIdentifier, "\" could not be found.")))]);
      return;
    }
    ...
    .then(function (f) {
      ...
      transfer(document, [13 /* FUNCTION_CALL */, 2 /* REJECT */, index, store(JSON.stringify("[worker-dom]: Function \"".concat(fnIdentifier, "\" threw: \"").concat(errorMessage, "\"")))]);
    });
  }
  ...
  var DocumentStub = /*#__PURE__*/function () {
    ...
    return _createClass(DocumentStub, [{
      key: "59",

var WorkerThread = (function (exports) {
    ...
    function transfer(document, mutation) {
      if (phase > 0 /* Initializing */ && document[58 /* allowTransfer */]) {
        ...
        Promise.resolve().then(_ => {
          if (pending) {
            const nodes = new Uint16Array(consume().reduce((acc, node) => acc.concat(node[8 /* creationFormat */]), [])).buffer;
            const mutations = new Uint16Array(pendingMutations$1).buffer;
            document.postMessage({
              [54 /* phase */]: phase,
              [12 /* type */]: phase === 2 /* Mutating */ ? 3 /* MUTATE */ : 2 /* HYDRATE */,
              [37 /* nodes */]: nodes,
              [41 /* strings */]: consume$1(),
    ...
    class AMP {
      ...
      getState(key = '') {
        return new Promise(resolve => {
          ...
          transfer(this.document, [12 /* STORAGE */, 1 /* GET */, 2 /* AmpState */, /* key */store$1(key) + 1, /* value */0]);
    ...
    function callFunctionMessageHandler(event, document) {
      ...
      if (!fn) {
        transfer(document, [13 /* FUNCTION_CALL */, 2 /* REJECT */, index, store$1(JSON.stringify(`[worker-dom]: Exported function "${fnIdentifier}" could not be found.`))]);
        return;
      }
      ...
      .then(f => f.apply(null, fnArguments)).then(value => {
        ...
        transfer(document, [13 /* FUNCTION_CALL */, 2 /* REJECT */, index, store$1(JSON.stringify(`[worker-dom]: Function "${fnIdentifier}" threw: "${errorMessage}"`))]);
      });
    }
    ...
    class Node {
      ...
      [56 /* insertedNode */](child) {
        ...
        propagate$3(child, 45 /* scopingRoot */, this[45 /* scopingRoot */]);
      }
      /**
      ...
      [57 /* removedNode */](child) {
        ...
        propagate$3(child, 45 /* scopingRoot */, child);
      }
      /**
    ...
    class CharacterData extends Node {
      constructor(data, nodeType, nodeName, ownerDocument, overrideIndex) {
        ...
        this[38 /* data */] = void 0;
        this[38 /* data */] = data;
        this[8 /* creationFormat */] = [this[7 /* index */], nodeType, store$1(nodeName), store$1(data), 0];
      }
      // Unimplemented Methods
    ...
    const elementPredicate = node => node.nodeType === 1 /* ELEMENT_NODE */;
    ...
    */
    ...
    function querySelectorAll(node, selector) {
      ...
      return matcher ? matchChildrenElements(node[45 /* scopingRoot */], matcher).filter(element => node !== element && node.contains(element)) : [];
    }
    ...
    class Element extends ParentNode {
      constructor(nodeType, localName, namespaceURI, ownerDocument, overrideIndex) {
        ...
        this[8 /* creationFormat */] = [this[7 /* index */], this.nodeType, store$1(this.localName), 0, this.namespaceURI === null ? 0 : store$1(this.namespaceURI)];
      }
      ...
      set innerHTML(html) {
        ...
        this.childNodes.forEach(n => {
          ...
          propagate$3(n, 45 /* scopingRoot */, n);
        });
        mutate(this.ownerDocument, {
          removedNodes: this.childNodes,
          type: 2 /* CHILD_LIST */,
          target: this
        }, [2 /* CHILD_LIST */, this[7 /* index */], 0, 0, 0, this.childNodes.length, ...this.childNodes.map(node => node[7 /* index */])]);
        this.childNodes = [];
        // add new children
      ...
      getBoundingClientRectAsync() {
        ...
        return new Promise(resolve => {
          const messageHandler = ({
            ...
            if (data[12 /* type */] === 6 /* GET_BOUNDING_CLIENT_RECT */ && data[13 /* target */][0] === this[7 /* index */]) {
    ...
    */
    ...
    class CanvasGradient {
      ...
      addColorStop(offset, color) {
        transfer(this.document, [9 /* OBJECT_MUTATION */, store$1('addColorStop'), 2, ...this[68 /* serializeAsTransferrableObject */](), ...serializeTransferrableObject([...arguments])]);
      }
      [68 /* serializeAsTransferrableObject */]() {
    ...
    class OffscreenCanvasRenderingContext2DPolyfill {
      ...
      [67 /* mutated */](fnName, args) {
        transfer(this.canvasElement.ownerDocument, [9 /* OBJECT_MUTATION */, store$1(fnName), args.length, ...this[68 /* serializeAsTransferrableObject */](), ...serializeTransferrableObject(args)]);
      }
      [68 /* serializeAsTransferrableObject */]() {
      ...
      createObjectReference(objectId, creationMethod, creationArgs) {
        transfer(this.canvasElement.ownerDocument, [10 /* OBJECT_CREATION */, store$1(creationMethod), objectId, creationArgs.length, ...this[68 /* serializeAsTransferrableObject */](), ...serializeTransferrableObject(creationArgs)]);
      }
      get canvas() {
    ...
    */
    ...
    class DocumentFragment extends ParentNode {
      constructor(ownerDocument, overrideIndex) {
        ...
        this[8 /* creationFormat */] = [this[7 /* index */], 11 /* DOCUMENT_FRAGMENT_NODE */, store$1(this.nodeName), 0, 0];
      }
      /**
       * @param deep boolean determines if the clone should include a recursive copy of all childNodes.

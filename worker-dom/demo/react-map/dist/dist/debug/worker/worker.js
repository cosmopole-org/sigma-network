var WorkerThread = (function (exports) {
  ...
  function storeOverride(node, override) {
    if (phase === 0 /* Initializing */) {
      mapping$1.set(node[7 /* index */] = override, node);
  ...
  function store$1(node) {
    ...
    mapping$1.set(node[7 /* index */] = ++count$1, node);
    if (phase > 0 /* Initializing */) {
    ...
    if (phase > 0 /* Initializing */ && document[58 /* allowTransfer */]) {
      ...
      Promise.resolve().then(function (_) {
        if (pending) {
          ...
          document.postMessage(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty({}, 54 /* phase */, phase), 12 /* type */, phase === 2 /* Mutating */ ? 3 /* MUTATE */ : 2), 37 /* nodes */, nodes), 41 /* strings */, consume()), 36 /* mutations */, mutations), [nodes, mutations]);
          pendingMutations$1 = [];
          pending = false;
          set(2 /* Mutating */);
        }
  ...
  var Node = /*#__PURE__*/function () {
    function Node(nodeType, nodeName, ownerDocument, overrideIndex) {
      ...
      this[7 /* index */] = overrideIndex ? storeOverride(this, overrideIndex) : store$1(this);
    ...
    return _createClass(Node, [{
      ...
      value: function removeEventListener(type, handler) {
        ...
        if (index >= 0) {
          ...
          transfer(this.ownerDocument, [4 /* EVENT_SUBSCRIPTION */, this[7 /* index */], 1, 0, store(lowerType), index]);
        }
      }
      /**
  ...
  */
    ...
    return _createClass(DOMTokenList, [{
      ...
      value: function _ /* mutated */(oldValue, value) {
        ...
        mutate(this[13 /* target */].ownerDocument, {
          ...
          value: value,
          oldValue: oldValue
        }, [0 /* ATTRIBUTES */, this[13 /* target */][7 /* index */], store(this[18 /* attributeName */]), 0, value !== null ? store(value) + 1 : 0]);
      }
    }]);
  }();
    ...
    return _createClass(CSSStyleDeclaration, [{
      ...
      value: function mutated(value) {
        ...
        mutate(this[13 /* target */].ownerDocument, {
          ...
          value: value,
          oldValue: oldValue
        }, [0 /* ATTRIBUTES */, this[13 /* target */][7 /* index */], store('style'), 0, value !== null ? store(value) + 1 : 0]);
      }
    }]);
  }();
  ...
  var Element = /*#__PURE__*/function (_ParentNode) {
    function Element(nodeType, localName, namespaceURI, ownerDocument, overrideIndex) {
      ...
      _this[8 /* creationFormat */] = [_this[7 /* index */], _this.nodeType, store(_this.localName), 0, _this.namespaceURI === null ? 0 : store(_this.namespaceURI)];
      return _this;
    }
    ...
    return _createClass(Element, [{
      ...
      value: function setAttributeNS(namespaceURI, name, value) {
        ...
        mutate(this.ownerDocument, {
          ...
          value: valueAsString,
          oldValue: oldValue
        }, [0 /* ATTRIBUTES */, this[7 /* index */], store(name), store(namespaceURI), value !== null ? store(valueAsString) + 1 : 0]);
      }
    }, {
      key: "44",
      ...
      value: function removeAttributeNS(namespaceURI, name) {
        ...
        if (index >= 0) {
          ...
          mutate(this.ownerDocument, {
            ...
            attributeNamespace: namespaceURI,
            oldValue: oldValue
          }, [0 /* ATTRIBUTES */, this[7 /* index */], store(name), store(namespaceURI), 0 // 0 means no value
          ]);
        }
      }
      /**
  ...
  var CanvasGradient = /*#__PURE__*/function () {
    ...
    return _createClass(CanvasGradient, [{
      ...
      value: function addColorStop(offset, color) {
        transfer(this.document, [9 /* OBJECT_MUTATION */, store('addColorStop'), 2].concat(_toConsumableArray(this[68 /* serializeAsTransferrableObject */]()), _toConsumableArray(serializeTransferrableObject(Array.prototype.slice.call(arguments)))));
      }
    }, {
      key: "68",
      value: function _ /* serializeAsTransferrableObject */() {
  ...
  var OffscreenCanvasRenderingContext2DPolyfill = /*#__PURE__*/function () {
    ...
    return _createClass(OffscreenCanvasRenderingContext2DPolyfill, [{
      ...
      value: function _ /* mutated */(fnName, args) {
        transfer(this.canvasElement.ownerDocument, [9 /* OBJECT_MUTATION */, store(fnName), args.length].concat(_toConsumableArray(this[68 /* serializeAsTransferrableObject */]()), _toConsumableArray(serializeTransferrableObject(args))));
      }
    }, {
      key: "68",
      value: function _ /* serializeAsTransferrableObject */() {
      ...
      value: function createObjectReference(objectId, creationMethod, creationArgs) {
        transfer(this.canvasElement.ownerDocument, [10 /* OBJECT_CREATION */, store(creationMethod), objectId, creationArgs.length].concat(_toConsumableArray(this[68 /* serializeAsTransferrableObject */]()), _toConsumableArray(serializeTransferrableObject(creationArgs))));
      }
    }, {
      key: "canvas",
      get: function get() {
  ...
  */
  ...
  var HTMLInputElement = /*#__PURE__*/function (_HTMLElement) {
    ...
    return _createClass(HTMLInputElement, [{
      ...
      set: function set(value) {
        ...
        transfer(this.ownerDocument, [3 /* PROPERTIES */, this[7 /* index */], store('value'), 0 /* FALSE */, store(value)]);
      }
    }, {
      key: "valueAsDate",
      get: function get() {
      ...
      set: function set(value) {
        ...
        transfer(this.ownerDocument, [3 /* PROPERTIES */, this[7 /* index */], store('checked'), 1 /* TRUE */, value === true ? 1 /* TRUE */ : 0 /* FALSE */]);
      }
      /**
  ...
  var HTMLOptionElement = /*#__PURE__*/function (_HTMLElement) {
    ...
    return _createClass(HTMLOptionElement, [{
      ...
      set: function set(value) {
        ...
        transfer(this.ownerDocument, [3 /* PROPERTIES */, this[7 /* index */], store('selected'), 1 /* TRUE */, this[52 /* selected */] ? 1 /* TRUE */ : 0 /* FALSE */]);
      }
      /**
       * A Synonym for the Node.textContent property getter.
       * @see https://developer.mozilla.org/en-US/docs/Web/API/HTMLOptionElement
  ...
  var CharacterData = /*#__PURE__*/function (_Node) {
    function CharacterData(data, nodeType, nodeName, ownerDocument, overrideIndex) {
      ...
      _this[38 /* data */] = data;
      _this[8 /* creationFormat */] = [_this[7 /* index */], nodeType, store(nodeName), store(data), 0];
      return _this;
    }
    // Unimplemented Methods
    ...
    return _createClass(CharacterData, [{
      ...
      set: function set(value) {
        ...
        mutate(this.ownerDocument, {
          ...
          value: value,
          oldValue: oldValue
        }, [1 /* CHARACTER_DATA */, this[7 /* index */], store(value)]);
      }
      /**
  ...
  var DocumentFragment = /*#__PURE__*/function (_ParentNode) {
    function DocumentFragment(ownerDocument, overrideIndex) {
      ...
      _this[8 /* creationFormat */] = [_this[7 /* index */], 11 /* DOCUMENT_FRAGMENT_NODE */, store(_this.nodeName), 0, 0];
      return _this;
    }
    /**
     * @param deep boolean determines if the clone should include a recursive copy of all childNodes.
  ...
  function createStorage(document, location, data) {
    ...
    define(storage, 'removeItem', {
      value: function value(key) {
        delete this[key];
        transfer(document, [12 /* STORAGE */, 2 /* SET */, location, store(key) + 1, 0 // value == 0 represents deletion.
        ]);
      }
    });

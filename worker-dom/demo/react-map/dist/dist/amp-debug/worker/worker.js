var WorkerThread = (function (exports) {
      ...
      Promise.resolve().then(function (_) {
        if (pending) {
          var nodes = new Uint16Array(consume().reduce(function (acc, node) {
            return acc.concat(node[8 /* creationFormat */]);
          }, [])).buffer;
          var mutations = new Uint16Array(pendingMutations$1).buffer;
          document.postMessage(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty({}, 54 /* phase */, phase), 12 /* type */, phase === 2 /* Mutating */ ? 3 /* MUTATE */ : 2), 37 /* nodes */, nodes), 41 /* strings */, consume$1()), 36 /* mutations */, mutations), [nodes, mutations]);
          pendingMutations$1 = [];
          pending = false;
          set(2 /* Mutating */);
        }
  ...
  var AMP = /*#__PURE__*/function () {
    ...
    return _createClass(AMP, [{
      ...
      value: function getState() {
        ...
        return new Promise(function (resolve) {
          var _messageHandler = function messageHandler(event) {
            ...
            _this.document.removeGlobalEventListener('message', _messageHandler);
            var value = storageMessage[21 /* value */];
            resolve(value);
          };
          _this.document.addGlobalEventListener('message', _messageHandler);
          transfer(_this.document, [12 /* STORAGE */, 1 /* GET */, 2 /* AmpState */, /* key */store$1(key) + 1, /* value */0]);
      ...
      value: function setState(state) {
        ...
        transfer(this.document, [12 /* STORAGE */, 2 /* SET */, 2 /* AmpState */, /* key */0, /* value */store$1(stringified) + 1]);
      }
    }]);
  }();
  ...
  function callFunctionMessageHandler(event, document) {
    ...
    var fnIdentifier = functionMessage[77 /* functionIdentifier */];
    var fnArguments = JSON.parse(functionMessage[78 /* functionArguments */]);
    var index = functionMessage[7 /* index */];
    var fn = exportedFunctions[fnIdentifier];
    if (!fn) {
      transfer(document, [13 /* FUNCTION_CALL */, 2 /* REJECT */, index, store$1(JSON.stringify("[worker-dom]: Exported function \"".concat(fnIdentifier, "\" could not be found.")))]);
      return;
    }
    ...
    .then(function (f) {
      ...
      transfer(document, [13 /* FUNCTION_CALL */, 1 /* RESOLVE */, index, store$1(JSON.stringify(value))]);
    }, function (err) {
      var errorMessage = JSON.stringify(err.message || err);
      transfer(document, [13 /* FUNCTION_CALL */, 2 /* REJECT */, index, store$1(JSON.stringify("[worker-dom]: Function \"".concat(fnIdentifier, "\" threw: \"").concat(errorMessage, "\"")))]);
    });
  }
   ...
   */
  var _propagate = function propagate(node, property, value) {
    node[property] = value;
    node.childNodes.forEach(function (child) {
      return _propagate(child, property, value);
    });
  };
  var Node = /*#__PURE__*/function () {
    function Node(nodeType, nodeName, ownerDocument, overrideIndex) {
      ...
      this[7 /* index */] = void 0;
      this[9 /* transferredFormat */] = void 0;
      this[8 /* creationFormat */] = void 0;
      this[10 /* handlers */] = {};
      this.nodeType = nodeType;
      this.nodeName = nodeName;
      this.ownerDocument = ownerDocument || this;
      this[45 /* scopingRoot */] = this;
      this[7 /* index */] = overrideIndex ? storeOverride(this, overrideIndex) : store(this);
    ...
    return _createClass(Node, [{
      ...
      value: function insertBefore(child, referenceNode) {
        ...
        if (child.nodeType === 11 /* DOCUMENT_FRAGMENT_NODE */) {
          ...
          mutate(this.ownerDocument, {
            ...
            type: 2 /* CHILD_LIST */,
            target: this
          }, [2 /* CHILD_LIST */, this[7 /* index */], referenceNode[7 /* index */], 0, 1, 0, child[7 /* index */]]);
          return child;
        }
        return null;
      }
      ...
      key: "56",
      value: function _ /* insertedNode */(child) {
        child.parentNode = this;
        _propagate(child, 'isConnected', this.isConnected);
        _propagate(child, 45 /* scopingRoot */, this[45 /* scopingRoot */]);
      }
      /**
      ...
      key: "57",
      value: function _ /* removedNode */(child) {
        child.parentNode = null;
        _propagate(child, 'isConnected', false);
        _propagate(child, 45 /* scopingRoot */, child);
      }
      /**
      ...
      value: function appendChild(child) {
        if (child.nodeType === 11 /* DOCUMENT_FRAGMENT_NODE */) {
          ...
          mutate(this.ownerDocument, {
            ...
            type: 2 /* CHILD_LIST */,
            target: this
          }, [2 /* CHILD_LIST */, this[7 /* index */], 0, previousSibling ? previousSibling[7 /* index */] : 0, 1, 0, child[7 /* index */]]);
        }
        return child;
      }
      /**
      ...
      value: function replaceChild(newChild, oldChild) {
        ...
        mutate(this.ownerDocument, {
          ...
          target: this
        }, [2 /* CHILD_LIST */, this[7 /* index */], this.childNodes[index + 1] ? this.childNodes[index + 1][7 /* index */] : 0, 0, 1, 1, newChild[7 /* index */], oldChild[7 /* index */]]);
        return oldChild;
      }
      /**
      ...
      value: function addEventListener(type, handler) {
        ...
        var handlers = this[10 /* handlers */][lowerType];
        var index = 0;
        if (handlers) {
        ...
        transfer(this.ownerDocument, [4 /* EVENT_SUBSCRIPTION */, this[7 /* index */], 0, 1, storedType, index, Number(Boolean(options.capture)), Number(Boolean(options.once)), Number(Boolean(options.passive)), Number(Boolean(options.workerDOMPreventDefault))]);
      }
      /**
      ...
      value: function removeEventListener(type, handler) {
        ...
        if (index >= 0) {
          ...
          transfer(this.ownerDocument, [4 /* EVENT_SUBSCRIPTION */, this[7 /* index */], 1, 0, store$1(lowerType), index]);
        }
      }
      /**
  ...
  function getPreviousElementSibling(node) {
    ...
    for (var i = parentNodes.indexOf(node) - 1; i >= 0; i--) {
      ...
      if (_node.nodeType === 1 /* ELEMENT_NODE */) {
        return _node;
      }
    }
    return null;
  ...
  function getNextElementSibling(node) {
    ...
    for (var i = parentNodes.indexOf(node) + 1; i < parentNodes.length; i++) {
      ...
      if (_node2.nodeType === 1 /* ELEMENT_NODE */) {
        return _node2;
      }
    }
    return null;
  ...
  var CharacterData = /*#__PURE__*/function (_Node) {
    function CharacterData(data, nodeType, nodeName, ownerDocument, overrideIndex) {
      ...
      _this = _callSuper(this, CharacterData, [nodeType, nodeName, ownerDocument, overrideIndex]);
      _this[38 /* data */] = void 0;
      _this[38 /* data */] = data;
      _this[8 /* creationFormat */] = [_this[7 /* index */], nodeType, store$1(nodeName), store$1(data), 0];
      return _this;
    }
    // Unimplemented Methods
    ...
    return _createClass(CharacterData, [{
      key: "data",
      get: function get() {
        return this[38 /* data */];
      }
      ...
      set: function set(value) {
        ...
        mutate(this.ownerDocument, {
          ...
          value: value,
          oldValue: oldValue
        }, [1 /* CHARACTER_DATA */, this[7 /* index */], store$1(value)]);
      }
      /**
  ...
  var Comment = /*#__PURE__*/function (_CharacterData) {
    function Comment(data, ownerDocument, overrideIndex) {
      ...
      return _callSuper(this, Comment, [data, 8 /* COMMENT_NODE */, '#comment', ownerDocument, overrideIndex]);
    }
    /**
  ...
  var _matchChildrenElements = function matchChildrenElements(node, conditionPredicate) {
    ...
    node.childNodes.forEach(function (child) {
      if (elementPredicate(child)) {
        ...
        matchingElements.push.apply(matchingElements, _toConsumableArray(_matchChildrenElements(child, conditionPredicate)));
      }
    });
    return matchingElements;
  };
  var _matchChildElement = function matchChildElement(element, conditionPredicate) {
    ...
    element.children.some(function (child) {
      ...
      var grandChildMatch = _matchChildElement(child, conditionPredicate);
  ...
  */
  var ParentNode = /*#__PURE__*/function (_Node) {
    function ParentNode() {
      ...
      return _callSuper(this, ParentNode, arguments);
    }
  ...
  function _querySelectorAll(node, selector) {
    ...
    var attrSelector = selectorHasAttr ? selector.substring(selectorBracketIndexes[0], selectorBracketIndexes[1] + 1) : null;
    ...
    return matcher ? _matchChildrenElements(node[45 /* scopingRoot */], matcher).filter(function (element) {
  ...
  var DOMTokenList = /*#__PURE__*/function () {
    ...
    function DOMTokenList(target, attributeName) {
      ...
      this[43 /* tokens */] = [];
      this[13 /* target */] = void 0;
      this[18 /* attributeName */] = void 0;
      this[44 /* storeAttribute */] = void 0;
    ...
    return _createClass(DOMTokenList, [{
      ...
      function set(collection) {
        ...
        var newValue = collection.trim();
        // Replace current tokens with new tokens.
        (_this$ = this[43 /* tokens */]).splice.apply(_this$, [0, this[43 /* tokens */].length].concat(_toConsumableArray(newValue !== '' ? newValue.split(/\s+/) : '')));
      ...
      value: function add() {
        ...
        (_this$2 = this[43 /* tokens */]).splice.apply(_this$2, [0, this[43 /* tokens */].length].concat(_toConsumableArray(Array.from(new Set(this[43 /* tokens */].concat(tokens))))));
      ...
      value: function remove() {
        ...
        var oldValue = this.value;
        (_this$3 = this[43 /* tokens */]).splice.apply(_this$3, [0, this[43 /* tokens */].length].concat(_toConsumableArray(Array.from(new Set(this[43 /* tokens */].filter(function (token) {
      ...
      value: function replace(token, newToken) {
        ...
        var oldValue = this.value;
        var set = new Set(this[43 /* tokens */]);
        if (token !== newToken) {
          set.delete(token);
          if (newToken !== '') {
            set.add(newToken);
        ...
        (_this$4 = this[43 /* tokens */]).splice.apply(_this$4, [0, this[43 /* tokens */].length].concat(_toConsumableArray(Array.from(set))));
        this[67 /* mutated */](oldValue, this.value);
      }
      /**
      ...
      key: "67",
      value: function _ /* mutated */(oldValue, value) {
        ...
        mutate(this[13 /* target */].ownerDocument, {
          ...
          value: value,
          oldValue: oldValue
        }, [0 /* ATTRIBUTES */, this[13 /* target */][7 /* index */], store$1(this[18 /* attributeName */]), 0, value !== null ? store$1(value) + 1 : 0]);
      }
    }]);
  }();
  ...
  var CSSStyleDeclaration = /*#__PURE__*/function () {
     ...
     */
    return _createClass(CSSStyleDeclaration, [{
      ...
      get: function get() {
        var value;
        var returnValue = '';
        for (var key in this[3 /* properties */]) {
      ...
      value: function mutated(value) {
        var oldValue = this[44 /* storeAttribute */](this[13 /* target */].namespaceURI, 'style', value);
        mutate(this[13 /* target */].ownerDocument, {
          type: 0 /* ATTRIBUTES */,
          target: this[13 /* target */],
          attributeName: 'style',
          value: value,
          oldValue: oldValue
        }, [0 /* ATTRIBUTES */, this[13 /* target */][7 /* index */], store$1('style'), 0, value !== null ? store$1(value) + 1 : 0]);
      }
    }]);
  }();
  ...
  function decodeEntities(html) {
    return html.replace(/&(?:(#x?[\da-f]+)|([\w]+));?/gi, function (s, numericEntity, namedEntity) {
      // Numeric entity
      if (numericEntity) {
        var code = numericEntity.charAt(1).toLowerCase() === 'x' ? parseInt(numericEntity.substr(2), 16) : parseInt(numericEntity.substr(1), 10);
  ...
  function propagate$2(global) {
    ...
    document.addGlobalEventListener('message', function (_ref) {
      ...
      var event = data[39 /* event */];
      var node = get(event[7 /* index */]);
      if (node !== null) {
        node.dispatchEvent(Object.assign(new Event$1(event[12 /* type */], {
  ...
  function definePropertyBackedAttributes(defineOn, attributes) {
    var sub = Object.create(defineOn[46 /* propertyBackedAttributes */]);
  ...
  var Element = /*#__PURE__*/function (_ParentNode) {
    function Element(nodeType, localName, namespaceURI, ownerDocument, overrideIndex) {
      ...
      _this = _callSuper(this, Element, [nodeType, toUpper(localName), ownerDocument, overrideIndex]);
      ...
      _this[8 /* creationFormat */] = [_this[7 /* index */], _this.nodeType, store$1(_this.localName), 0, _this.namespaceURI === null ? 0 : store$1(_this.namespaceURI)];
      return _this;
    }
    ...
    return _createClass(Element, [{
      ...
      set: function set(html) {
        var _this2 = this;
        var root = parse(html, this);
        // remove previous children
        this.childNodes.forEach(function (n) {
          _propagate(n, 'isConnected', false);
          _propagate(n, 45 /* scopingRoot */, n);
        });
        mutate(this.ownerDocument, {
          removedNodes: this.childNodes,
          type: 2 /* CHILD_LIST */,
          target: this
        }, [2 /* CHILD_LIST */, this[7 /* index */], 0, 0, 0, this.childNodes.length].concat(_toConsumableArray(this.childNodes.map(function (node) {
          return node[7 /* index */];
        }))));
        this.childNodes = [];
        // add new children
      ...
      value: function setAttributeNS(namespaceURI, name, value) {
        ...
        var propertyBacked = this.constructor[46 /* propertyBackedAttributes */][name];
        ...
        var oldValue = this[44 /* storeAttribute */](namespaceURI, name, valueAsString);
        mutate(this.ownerDocument, {
          type: 0 /* ATTRIBUTES */,
          target: this,
          attributeName: name,
          ...
          value: valueAsString,
          oldValue: oldValue
        }, [0 /* ATTRIBUTES */, this[7 /* index */], store$1(name), store$1(namespaceURI), value !== null ? store$1(valueAsString) + 1 : 0]);
      }
    }, {
      key: "44",
      value: function _ /* storeAttribute */(namespaceURI, name, value) {
      ...
      value: function removeAttributeNS(namespaceURI, name) {
        ...
        if (index >= 0) {
          ...
          mutate(this.ownerDocument, {
            ...
            attributeNamespace: namespaceURI,
            oldValue: oldValue
          }, [0 /* ATTRIBUTES */, this[7 /* index */], store$1(name), store$1(namespaceURI), 0 // 0 means no value
          ]);
        }
      }
      /**
      ...
      value: function getElementsByClassName(names) {
        var inputClassList = names.split(' ');
        ...
        return _matchChildrenElements(this, function (element) {
      ...
      value: function getElementsByTagName(tagName) {
        ...
        return _matchChildrenElements(this, tagName === '*' ? function (_) {
          return true;
        } : function (element) {
      ...
      value: function getBoundingClientRectAsync() {
        ...
        return new Promise(function (resolve) {
          var _messageHandler = function messageHandler(_ref) {
            var data = _ref.data;
            if (data[12 /* type */] === 6 /* GET_BOUNDING_CLIENT_RECT */ && data[13 /* target */][0] === _this3[7 /* index */]) {
              _this3.ownerDocument.removeGlobalEventListener('message', _messageHandler);
              var transferredBoundingClientRect = data[38 /* data */];
              resolve({
          ...
          if (!_this3.ownerDocument.addGlobalEventListener || !_this3.isConnected) {
            ...
            _this3.ownerDocument.addGlobalEventListener('message', _messageHandler);
            transfer(_this3.ownerDocument, [5 /* GET_BOUNDING_CLIENT_RECT */, _this3[7 /* index */]]);
  ...
  Element[46 /* propertyBackedAttributes */] = {
    class: [function (el) {
  ...
  var appendGlobalEventProperties = function appendGlobalEventProperties(keys) {
    ...
    keysToAppend.forEach(function (key) {
      ...
      Object.defineProperty(HTMLElement.prototype, key, {
        ...
        set: function set(value) {
          var stored = this[76 /* propertyEventHandlers */][normalizedKey];
          if (stored) {
  ...
  var HTMLElement = /*#__PURE__*/function (_Element) {
    function HTMLElement() {
      ...
      _this = _callSuper(this, HTMLElement, [].concat(args));
      _this[76 /* propertyEventHandlers */] = {};
      return _this;
    }
    ...
    return _createClass(HTMLElement, [{
      ...
      key: "68",
      value: function _ /* serializeAsTransferrableObject */() {
  ...
  var HTMLAnchorElement = /*#__PURE__*/function (_HTMLElement) {
    function HTMLAnchorElement() {
      ...
      _this = _callSuper(this, HTMLAnchorElement, [].concat(args));
  ...
  */
  ...
  var HTMLButtonElement = /*#__PURE__*/function (_HTMLElement) {
    function HTMLButtonElement() {
      ...
      return _callSuper(this, HTMLButtonElement, arguments);
    }
    _inherits(HTMLButtonElement, _HTMLElement);
    return _createClass(HTMLButtonElement);
  }(HTMLElement);
  ...
  function serializeTransferrableObject(args) {
    ...
    for (var i = 0; i < args.length; i++) {
      ...
      if (typeof arg === 'string') {
        serialized.push(3 /* String */, store$1(arg));
        continue;
      }
      ...
      if (_typeof(arg) === 'object') {
        var serializedObject = arg[68 /* serializeAsTransferrableObject */]();
  ...
  var CanvasGradient = /*#__PURE__*/function () {
    ...
    return _createClass(CanvasGradient, [{
      key: "addColorStop",
      value: function addColorStop(offset, color) {
        transfer(this.document, [9 /* OBJECT_MUTATION */, store$1('addColorStop'), 2].concat(_toConsumableArray(this[68 /* serializeAsTransferrableObject */]()), _toConsumableArray(serializeTransferrableObject(Array.prototype.slice.call(arguments)))));
      }
    }, {
      key: "68",
      value: function _ /* serializeAsTransferrableObject */() {
  ...
  var CanvasPattern = /*#__PURE__*/function () {
     ...
     */
    return _createClass(CanvasPattern, [{
      key: "setTransform",
  ...
  var OffscreenCanvasPolyfill = /*#__PURE__*/function () {
    ...
    return _createClass(OffscreenCanvasPolyfill, [{
      key: "getContext",
  ...
  var OffscreenCanvasRenderingContext2DPolyfill = /*#__PURE__*/function () {
    ...
    return _createClass(OffscreenCanvasRenderingContext2DPolyfill, [{
      key: "67",
      value: function _ /* mutated */(fnName, args) {
        transfer(this.canvasElement.ownerDocument, [9 /* OBJECT_MUTATION */, store$1(fnName), args.length].concat(_toConsumableArray(this[68 /* serializeAsTransferrableObject */]()), _toConsumableArray(serializeTransferrableObject(args))));
      }
    }, {
      key: "68",
      value: function _ /* serializeAsTransferrableObject */() {
      ...
      value: function createObjectReference(objectId, creationMethod, creationArgs) {
        transfer(this.canvasElement.ownerDocument, [10 /* OBJECT_CREATION */, store$1(creationMethod), objectId, creationArgs.length].concat(_toConsumableArray(this[68 /* serializeAsTransferrableObject */]()), _toConsumableArray(serializeTransferrableObject(creationArgs))));
      }
    }, {
      key: "canvas",
      get: function get() {
      ...
      value: function clearRect(x, y, w, h) {
        this[67 /* mutated */]('clearRect', Array.prototype.slice.call(arguments));
      }
    }, {
      key: "fillRect",
      value: function fillRect(x, y, w, h) {
        this[67 /* mutated */]('fillRect', Array.prototype.slice.call(arguments));
      }
    }, {
      key: "strokeRect",
      value: function strokeRect(x, y, w, h) {
        this[67 /* mutated */]('strokeRect', Array.prototype.slice.call(arguments));
      }
    }, {
      key: "lineWidth",
      set: function set(value) {
        this[67 /* mutated */]('lineWidth', Array.prototype.slice.call(arguments));
      }
    }, {
      key: "fillText",
      value: function fillText(text, x, y, maxWidth) {
        this[67 /* mutated */]('fillText', Array.prototype.slice.call(arguments));
      }
    }, {
      key: "moveTo",
      value: function moveTo(x, y) {
        this[67 /* mutated */]('moveTo', Array.prototype.slice.call(arguments));
      }
    }, {
      key: "lineTo",
      value: function lineTo(x, y) {
        this[67 /* mutated */]('lineTo', Array.prototype.slice.call(arguments));
      }
    }, {
      key: "closePath",
      ...
      value: function rotate(angle) {
        this[67 /* mutated */]('rotate', Array.prototype.slice.call(arguments));
      }
    }, {
      key: "transform",
      value: function transform(a, b, c, d, e, f) {
        this[67 /* mutated */]('transform', Array.prototype.slice.call(arguments));
      }
    }, {
      key: "translate",
      value: function translate(x, y) {
        this[67 /* mutated */]('translate', Array.prototype.slice.call(arguments));
      }
    }, {
      key: "scale",
      value: function scale(x, y) {
        this[67 /* mutated */]('scale', Array.prototype.slice.call(arguments));
      }
    }, {
      key: "globalAlpha",
      set: function set(value) {
        this[67 /* mutated */]('globalAlpha', Array.prototype.slice.call(arguments));
      }
    }, {
      key: "globalCompositeOperation",
      set: function set(value) {
        this[67 /* mutated */]('globalCompositeOperation', Array.prototype.slice.call(arguments));
      }
    }, {
      key: "imageSmoothingQuality",
      set: function set(value) {
        this[67 /* mutated */]('imageSmoothingQuality', Array.prototype.slice.call(arguments));
      }
    }, {
      key: "fillStyle",
      set: function set(value) {
        this[67 /* mutated */]('fillStyle', Array.prototype.slice.call(arguments));
      }
    }, {
      key: "strokeStyle",
      set: function set(value) {
        this[67 /* mutated */]('strokeStyle', Array.prototype.slice.call(arguments));
      }
    }, {
      key: "shadowBlur",
      set: function set(value) {
        this[67 /* mutated */]('shadowBlur', Array.prototype.slice.call(arguments));
      }
    }, {
      key: "shadowColor",
      set: function set(value) {
        this[67 /* mutated */]('shadowColor', Array.prototype.slice.call(arguments));
      }
    }, {
      key: "shadowOffsetX",
      set: function set(value) {
        this[67 /* mutated */]('shadowOffsetX', Array.prototype.slice.call(arguments));
      }
    }, {
      key: "shadowOffsetY",
      set: function set(value) {
        this[67 /* mutated */]('shadowOffsetY', Array.prototype.slice.call(arguments));
      }
    }, {
      key: "filter",
      set: function set(value) {
        this[67 /* mutated */]('filter', Array.prototype.slice.call(arguments));
      }
    }, {
      key: "beginPath",
      ...
      value: function strokeText(text, x, y, maxWidth) {
        this[67 /* mutated */]('strokeText', Array.prototype.slice.call(arguments));
      }
    }, {
      key: "textAlign",
      set: function set(value) {
        this[67 /* mutated */]('textAlign', Array.prototype.slice.call(arguments));
      }
    }, {
      key: "textBaseline",
      set: function set(value) {
        this[67 /* mutated */]('textBaseline', Array.prototype.slice.call(arguments));
      }
    }, {
      key: "lineCap",
      set: function set(value) {
        this[67 /* mutated */]('lineCap', Array.prototype.slice.call(arguments));
      }
    }, {
      key: "lineDashOffset",
      set: function set(value) {
        this[67 /* mutated */]('lineDashOffset', Array.prototype.slice.call(arguments));
      }
    }, {
      key: "lineJoin",
      set: function set(value) {
        this[67 /* mutated */]('lineJoin', Array.prototype.slice.call(arguments));
      }
    }, {
      key: "miterLimit",
      set: function set(value) {
        this[67 /* mutated */]('miterLimit', Array.prototype.slice.call(arguments));
      }
    }, {
      key: "arc",
      value: function arc(x, y, radius, startAngle, endAngle, anticlockwise) {
        this[67 /* mutated */]('arc', Array.prototype.slice.call(arguments));
      }
    }, {
      key: "arcTo",
      value: function arcTo(x1, y1, x2, y2, radius) {
        this[67 /* mutated */]('arcTo', Array.prototype.slice.call(arguments));
      }
    }, {
      key: "direction",
      set: function set(value) {
        this[67 /* mutated */]('direction', Array.prototype.slice.call(arguments));
      }
    }, {
      key: "font",
      set: function set(value) {
        this[67 /* mutated */]('font', Array.prototype.slice.call(arguments));
      }
    }, {
      key: "ellipse",
      value: function ellipse(x, y, radiusX, radiusY, rotation, startAngle, endAngle, anticlockwise) {
        this[67 /* mutated */]('ellipse', Array.prototype.slice.call(arguments));
      }
    }, {
      key: "bezierCurveTo",
      value: function bezierCurveTo(cp1x, cp1y, cp2x, cp2y, x, y) {
        this[67 /* mutated */]('bezierCurveTo', Array.prototype.slice.call(arguments));
      }
    }, {
      key: "rect",
      value: function rect(x, y, width, height) {
        this[67 /* mutated */]('rect', Array.prototype.slice.call(arguments));
      }
    }, {
      key: "quadraticCurveTo",
      value: function quadraticCurveTo(cpx, cpy, x, y) {
        this[67 /* mutated */]('quadraticCurveTo', Array.prototype.slice.call(arguments));
      }
    }, {
      key: "imageSmoothingEnabled",
      set: function set(value) {
        this[67 /* mutated */]('imageSmoothingEnabled', Array.prototype.slice.call(arguments));
      }
    }, {
      key: "setLineDash",
      value: function setLineDash(lineDash) {
        ...
        this[67 /* mutated */]('setLineDash', Array.prototype.slice.call(arguments));
      }
    }, {
      key: "getLineDash",
      ...
      value: function clip(pathOrFillRule, fillRule) {
        ...
        this[67 /* mutated */]('clip', Array.prototype.slice.call(arguments));
      }
    }, {
      key: "fill",
      value: function fill(pathOrFillRule, fillRule) {
        ...
        this[67 /* mutated */]('fill', Array.prototype.slice.call(arguments));
      }
      ...
      value: function setTransform(transformOrA, bOrC, cOrD, dOrE, eOrF, f) {
        ...
        this[67 /* mutated */]('setTransform', Array.prototype.slice.call(arguments));
      }
    }, {
      ...
      value: function drawImage(image, dx, dy) {
        this[67 /* mutated */]('drawImage', Array.prototype.slice.call(arguments));
      }
    }, {
      key: "createImageData",
    ...
    return new Promise(function (resolve) {
      var _messageHandler = function messageHandler(_ref) {
        ...
        if (data[12 /* type */] === 10 /* IMAGE_BITMAP_INSTANCE */ && data[73 /* callIndex */] === callIndex) {
          document.removeGlobalEventListener('message', _messageHandler);
          var transferredImageBitmap = data[38 /* data */];
      ...
      if (!document.addGlobalEventListener) {
        ...
        document.addGlobalEventListener('message', _messageHandler);
  ...
  var FakeNativeCanvasPattern = /*#__PURE__*/function () {
    function FakeNativeCanvasPattern() {
      ...
      this[70 /* patternImplementation */] = {};
      this[71 /* patternUpgraded */] = false;
      this[72 /* patternUpgradePromise */] = void 0;
    }
    return _createClass(FakeNativeCanvasPattern, [{
      key: "69",
      value:
      /**
       ...
       */
      function _ /* retrieveCanvasPattern */(canvas, image, repetition) {
        var _this = this;
        ...
        .then(function (instance) {
          ...
          _this[70 /* patternImplementation */] = pattern;
          _this[71 /* patternUpgraded */] = true;
        });
  ...
  var CanvasRenderingContext2DShim = /*#__PURE__*/function () {
    function CanvasRenderingContext2DShim(canvas) {
      ...
      this.canvasElement = canvas;
      var OffscreenCanvas = canvas.ownerDocument.defaultView.OffscreenCanvas;
     ...
     */
    return _createClass(CanvasRenderingContext2DShim, [{
      ...
      value: function getOffscreenCanvasAsync(canvas) {
        ...
        var upgradePromise = new Promise(function (resolve) {
          var _messageHandler = function messageHandler(_ref) {
            var data = _ref.data;
            if (data[12 /* type */] === 9 /* OFFSCREEN_CANVAS_INSTANCE */ && data[13 /* target */][0] === canvas[7 /* index */]) {
              document.removeGlobalEventListener('message', _messageHandler);
              var transferredOffscreenCanvas = data[38 /* data */];
      ...
      set: function set(value) {
        ...
        if (value instanceof FakeNativeCanvasPattern && this.upgraded) {
          ...
          if (!value[71 /* patternUpgraded */]) {
            ...
            value[72 /* patternUpgradePromise */].then(function () {
      ...
      value: function createPattern(image, repetition) {
        var _this4 = this;
        var ImageBitmap = this.canvasElement.ownerDocument.defaultView.ImageBitmap;
        ...
        if (this.polyfillUsed || image instanceof ImageBitmap) {
          ...
          fakePattern[69 /* retrieveCanvasPattern */](this.canvas, image, repetition).then(function () {
  ...
  var HTMLCanvasElement = /*#__PURE__*/function (_HTMLElement) {
    function HTMLCanvasElement() {
      ...
      _this = _callSuper(this, HTMLCanvasElement, [].concat(args));
  ...
  var HTMLDataElement = /*#__PURE__*/function (_HTMLElement) {
    function HTMLDataElement() {
      ...
      return _callSuper(this, HTMLDataElement, arguments);
    }
    _inherits(HTMLDataElement, _HTMLElement);
    return _createClass(HTMLDataElement);
  }(HTMLElement);
  ...
  var HTMLDataListElement = /*#__PURE__*/function (_HTMLElement) {
    function HTMLDataListElement() {
      ...
      return _callSuper(this, HTMLDataListElement, arguments);
    }
    _inherits(HTMLDataListElement, _HTMLElement);
    return _createClass(HTMLDataListElement, [{
      key: "options",
      get:
      /**
  ...
  var HTMLEmbedElement = /*#__PURE__*/function (_HTMLElement) {
    function HTMLEmbedElement() {
      ...
      return _callSuper(this, HTMLEmbedElement, arguments);
    }
    _inherits(HTMLEmbedElement, _HTMLElement);
    return _createClass(HTMLEmbedElement);
  }(HTMLElement);
  ...
  var HTMLFormControlsCollectionMixin = function HTMLFormControlsCollectionMixin(defineOn) {
    Object.defineProperty(defineOn.prototype, 'elements', {
       ...
       */
      get: function get() {
        return _matchChildrenElements(this, tagNameConditionPredicate(MATCHING_CHILD_ELEMENT_TAGNAMES));
      }
    });
  };
  ...
  var HTMLFieldSetElement = /*#__PURE__*/function (_HTMLElement) {
    function HTMLFieldSetElement() {
      ...
      return _callSuper(this, HTMLFieldSetElement, arguments);
    }
    _inherits(HTMLFieldSetElement, _HTMLElement);
    return _createClass(HTMLFieldSetElement, [{
      key: "type",
      get:
      /**
       * @see https://developer.mozilla.org/en-US/docs/Web/API/HTMLFieldSetElement
  ...
  var HTMLFormElement = /*#__PURE__*/function (_HTMLElement) {
    function HTMLFormElement() {
      ...
      return _callSuper(this, HTMLFormElement, arguments);
    }
    _inherits(HTMLFormElement, _HTMLElement);
    return _createClass(HTMLFormElement, [{
      key: "length",
      get:
      /**
  ...
  */
  ...
  var HTMLIFrameElement = /*#__PURE__*/function (_HTMLElement) {
    function HTMLIFrameElement() {
      ...
      _this = _callSuper(this, HTMLIFrameElement, [].concat(args));
      _this._sandbox = void 0;
      return _this;
    }
    _inherits(HTMLIFrameElement, _HTMLElement);
    return _createClass(HTMLIFrameElement, [{
      key: "sandbox",
      get:
  ...
  var HTMLImageElement = /*#__PURE__*/function (_HTMLElement) {
    function HTMLImageElement() {
      ...
      return _callSuper(this, HTMLImageElement, arguments);
    }
  ...
  var HTMLInputLabelsMixin = function HTMLInputLabelsMixin(defineOn) {
    Object.defineProperty(defineOn.prototype, 'labels', {
      ...
      get: function get() {
        var _this = this;
        return _matchChildrenElements(this.ownerDocument || this, function (element) {
  ...
  var HTMLInputElement = /*#__PURE__*/function (_HTMLElement) {
    function HTMLInputElement() {
      ...
      _this = _callSuper(this, HTMLInputElement, [].concat(args));
    ...
    return _createClass(HTMLInputElement, [{
      ...
      set: function set(value) {
        ...
        transfer(this.ownerDocument, [3 /* PROPERTIES */, this[7 /* index */], store$1('value'), 0 /* FALSE */, store$1(value)]);
      }
    }, {
      key: "valueAsDate",
      get: function get() {
      ...
      set: function set(value) {
        ...
        transfer(this.ownerDocument, [3 /* PROPERTIES */, this[7 /* index */], store$1('checked'), 1 /* TRUE */, value === true ? 1 /* TRUE */ : 0 /* FALSE */]);
      }
      /**
  ...
  var HTMLLabelElement = /*#__PURE__*/function (_HTMLElement) {
    function HTMLLabelElement() {
      ...
      return _callSuper(this, HTMLLabelElement, arguments);
    }
    _inherits(HTMLLabelElement, _HTMLElement);
    return _createClass(HTMLLabelElement, [{
      key: "control",
      get:
      /**
      ...
      function get() {
        ...
        return _matchChildElement(this, tagNameConditionPredicate(['INPUT']));
      }
    }]);
  }(HTMLElement);
  ...
  var HTMLLinkElement = /*#__PURE__*/function (_HTMLElement) {
    function HTMLLinkElement() {
      ...
      _this = _callSuper(this, HTMLLinkElement, [].concat(args));
      _this._relList = void 0;
      return _this;
    }
    _inherits(HTMLLinkElement, _HTMLElement);
    return _createClass(HTMLLinkElement, [{
      key: "relList",
      get: function get() {
        return this._relList || (this._relList = new DOMTokenList(this, 'rel'));
      }
  ...
  var HTMLMapElement = /*#__PURE__*/function (_HTMLElement) {
    function HTMLMapElement() {
      ...
      return _callSuper(this, HTMLMapElement, arguments);
    }
    _inherits(HTMLMapElement, _HTMLElement);
    return _createClass(HTMLMapElement, [{
      key: "areas",
      get:
      /**
  ...
  var HTMLMeterElement = /*#__PURE__*/function (_HTMLElement) {
    function HTMLMeterElement() {
      ...
      return _callSuper(this, HTMLMeterElement, arguments);
    }
    _inherits(HTMLMeterElement, _HTMLElement);
    return _createClass(HTMLMeterElement);
  }(HTMLElement);
  ...
  var HTMLModElement = /*#__PURE__*/function (_HTMLElement) {
    function HTMLModElement() {
      ...
      return _callSuper(this, HTMLModElement, arguments);
    }
    _inherits(HTMLModElement, _HTMLElement);
    return _createClass(HTMLModElement);
  }(HTMLElement);
  ...
  var HTMLOListElement = /*#__PURE__*/function (_HTMLElement) {
    function HTMLOListElement() {
      ...
      return _callSuper(this, HTMLOListElement, arguments);
    }
    _inherits(HTMLOListElement, _HTMLElement);
    return _createClass(HTMLOListElement);
  }(HTMLElement);
  ...
  var HTMLOptionElement = /*#__PURE__*/function (_HTMLElement) {
    function HTMLOptionElement() {
      ...
      _this = _callSuper(this, HTMLOptionElement, [].concat(args));
      _this[52 /* selected */] = false;
      return _this;
    }
    _inherits(HTMLOptionElement, _HTMLElement);
    return _createClass(HTMLOptionElement, [{
      key: "index",
      get:
      /**
      ...
      set: function set(value) {
        ...
        transfer(this.ownerDocument, [3 /* PROPERTIES */, this[7 /* index */], store$1('selected'), 1 /* TRUE */, this[52 /* selected */] ? 1 /* TRUE */ : 0 /* FALSE */]);
      }
      /**
       * A Synonym for the Node.textContent property getter.
       * @see https://developer.mozilla.org/en-US/docs/Web/API/HTMLOptionElement
  ...
  var HTMLProgressElement = /*#__PURE__*/function (_HTMLElement) {
    function HTMLProgressElement() {
      ...
      _this = _callSuper(this, HTMLProgressElement, [].concat(args));
      _this[48 /* indeterminate */] = true;
      _this[21 /* value */] = 0;
      _this.dirtyValue = false;
      return _this;
    }
    _inherits(HTMLProgressElement, _HTMLElement);
    return _createClass(HTMLProgressElement, [{
      key: "position",
      get: function get() {
  ...
  var HTMLQuoteElement = /*#__PURE__*/function (_HTMLElement) {
    function HTMLQuoteElement() {
      ...
      return _callSuper(this, HTMLQuoteElement, arguments);
    }
    _inherits(HTMLQuoteElement, _HTMLElement);
    return _createClass(HTMLQuoteElement);
  }(HTMLElement);
  ...
  var HTMLScriptElement = /*#__PURE__*/function (_HTMLElement) {
    function HTMLScriptElement() {
      ...
      return _callSuper(this, HTMLScriptElement, arguments);
    }
  ...
  var HTMLSelectElement = /*#__PURE__*/function (_HTMLElement) {
    function HTMLSelectElement() {
      ...
      _this = _callSuper(this, HTMLSelectElement, [].concat(args));
      _this[49 /* size */] = -1 /* UNMODIFIED */;
      return _this;
    }
    _inherits(HTMLSelectElement, _HTMLElement);
    return _createClass(HTMLSelectElement, [{
      key: "56",
      value:
      /**
       ...
       * @param child
       */
      function _ /* insertedNode */(child) {
        _superPropGet(HTMLSelectElement, 56 /* insertedNode */, this, 3)([child]);
      ...
      key: "57",
      value: function _ /* removedNode */(child) {
        _superPropGet(HTMLSelectElement, 57 /* removedNode */, this, 3)([child]);
      ...
      key: "selectedIndex",
      get: function get() {
        var firstSelectedChild = _matchChildElement(this, isSelectedOptionPredicate);
      ...
      key: "selectedOptions",
      get: function get() {
        return _matchChildrenElements(this, isSelectedOptionPredicate);
      }
      /**
      ...
      key: "size",
      get: function get() {
        return this[49 /* size */] === -1 /* UNMODIFIED */ ? this.multiple ? 4 /* MULTIPLE */ : 1 /* SINGLE */ : this[49 /* size */];
      }
      /**
  ...
  var HTMLSourceElement = /*#__PURE__*/function (_HTMLElement) {
    function HTMLSourceElement() {
      ...
      return _callSuper(this, HTMLSourceElement, arguments);
    }
    _inherits(HTMLSourceElement, _HTMLElement);
    return _createClass(HTMLSourceElement);
  }(HTMLElement);
  ...
  var HTMLStyleElement = /*#__PURE__*/function (_HTMLElement) {
    function HTMLStyleElement() {
      ...
      return _callSuper(this, HTMLStyleElement, arguments);
    }
  ...
  var HTMLTableCellElement = /*#__PURE__*/function (_HTMLElement) {
    function HTMLTableCellElement() {
      ...
      _this = _callSuper(this, HTMLTableCellElement, [].concat(args));
      _this._headers = void 0;
      return _this;
    }
    _inherits(HTMLTableCellElement, _HTMLElement);
    return _createClass(HTMLTableCellElement, [{
      key: "headers",
      get: function get() {
      ...
      get: function get() {
        ...
        return parent !== null ? _matchChildrenElements(parent, tagNameConditionPredicate(['TH', 'TD'])).indexOf(this) : -1;
      }
    }]);
  }(HTMLElement);
  ...
  var HTMLTableColElement = /*#__PURE__*/function (_HTMLElement) {
    function HTMLTableColElement() {
      ...
      return _callSuper(this, HTMLTableColElement, arguments);
    }
    _inherits(HTMLTableColElement, _HTMLElement);
    return _createClass(HTMLTableColElement);
  }(HTMLElement);
  ...
  var insertBeforeElementsWithTagName = function insertBeforeElementsWithTagName(parent, element, tagNames) {
    var insertBeforeElement = _matchChildElement(parent, function (element) {
      return !tagNames.includes(element.tagName);
    });
  ...
  var HTMLTableElement = /*#__PURE__*/function (_HTMLElement) {
    function HTMLTableElement() {
      ...
      return _callSuper(this, HTMLTableElement, arguments);
    }
    _inherits(HTMLTableElement, _HTMLElement);
    return _createClass(HTMLTableElement, [{
      key: "caption",
      get:
      /**
       ...
       */
      function get() {
        return _matchChildElement(this, tagNameConditionPredicate(['CAPTION']));
      }
      /**
       * @see https://developer.mozilla.org/en-US/docs/Web/API/HTMLTableElement/caption
      ...
      key: "tHead",
      get: function get() {
        return _matchChildElement(this, tagNameConditionPredicate(['THEAD']));
      }
      /**
       * @see https://developer.mozilla.org/en-US/docs/Web/API/HTMLTableElement/tHead
      ...
      key: "tFoot",
      get: function get() {
        return _matchChildElement(this, tagNameConditionPredicate(['TFOOT']));
      }
      /**
       * @see https://developer.mozilla.org/en-US/docs/Web/API/HTMLTableElement/tHead
      ...
      key: "rows",
      get: function get() {
        return _matchChildrenElements(this, tagNameConditionPredicate(['TR']));
      }
      /**
       * @see https://developer.mozilla.org/en-US/docs/Web/API/HTMLTableElement
      ...
      key: "tBodies",
      get: function get() {
        return _matchChildrenElements(this, tagNameConditionPredicate(['TBODY']));
      }
    }]);
  }(HTMLElement);
  ...
  var indexInAncestor = function indexInAncestor(element, isValidAncestor) {
    var parent = matchNearestParent(element, isValidAncestor);
  ...
  var HTMLTableRowElement = /*#__PURE__*/function (_HTMLElement) {
    function HTMLTableRowElement() {
      ...
      return _callSuper(this, HTMLTableRowElement, arguments);
    }
    _inherits(HTMLTableRowElement, _HTMLElement);
    return _createClass(HTMLTableRowElement, [{
      key: "cells",
      get:
      /**
       ...
       */
      function get() {
        return _matchChildrenElements(this, tagNameConditionPredicate(['TD', 'TH']));
      }
      /**
       * @see https://developer.mozilla.org/en-US/docs/Web/API/HTMLTableRowElement
  ...
  var HTMLTableSectionElement = /*#__PURE__*/function (_HTMLElement) {
    function HTMLTableSectionElement() {
      ...
      return _callSuper(this, HTMLTableSectionElement, arguments);
    }
    _inherits(HTMLTableSectionElement, _HTMLElement);
    return _createClass(HTMLTableSectionElement, [{
      key: "rows",
      get:
      /**
  ...
  var HTMLTimeElement = /*#__PURE__*/function (_HTMLElement) {
    function HTMLTimeElement() {
      ...
      return _callSuper(this, HTMLTimeElement, arguments);
    }
    _inherits(HTMLTimeElement, _HTMLElement);
    return _createClass(HTMLTimeElement);
  }(HTMLElement);
  ...
  var Text = /*#__PURE__*/function (_CharacterData) {
    function Text(data, ownerDocument, overrideIndex) {
      ...
      return _callSuper(this, Text, [data, 3 /* TEXT_NODE */, '#text', ownerDocument, overrideIndex]);
    }
    // Unimplemented Properties
  ...
  var DocumentFragment = /*#__PURE__*/function (_ParentNode) {
    function DocumentFragment(ownerDocument, overrideIndex) {
      ...
      _this = _callSuper(this, DocumentFragment, [11 /* DOCUMENT_FRAGMENT_NODE */, '#document-fragment', ownerDocument, overrideIndex]);
      _this[8 /* creationFormat */] = [_this[7 /* index */], 11 /* DOCUMENT_FRAGMENT_NODE */, store$1(_this.nodeName), 0, 0];
      return _this;
    }
    /**
     * @param deep boolean determines if the clone should include a recursive copy of all childNodes.
    ...
    return _createClass(DocumentFragment, [{
      key: "cloneNode",
      value: function cloneNode() {
        var deep = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : false;
  ...
  function propagate$1(global) {
    ...
    document.addGlobalEventListener('message', function (_ref) {
      ...
      var sync = data[40 /* sync */];
      var node = get(sync[7 /* index */]);
      if (node) {
  ...
  var Document = /*#__PURE__*/function (_Element) {
    function Document(global) {
      ...
      _this = _callSuper(this, Document, [9 /* DOCUMENT_NODE */, DOCUMENT_NAME, HTML_NAMESPACE, null]);
      ...
      _this[58 /* allowTransfer */] = true;
      _this.nodeName = DOCUMENT_NAME;
      _this.documentElement = _this; // TODO(choumx): Should be the <html> element.
      _this.defaultView = Object.assign(global, {
        document: _this,
        addEventListener: _this.addEventListener.bind(_this),
        removeEventListener: _this.removeEventListener.bind(_this)
      });
      return _this;
    }
    /**
    ...
    return _createClass(Document, [{
      ...
      key: "64",
      value: function _ /* hydrateNode */(strings, skeleton) {
        var _this2 = this;
        switch (skeleton[0 /* nodeType */]) {
          ...
          default:
            var namespaceURI = strings[skeleton[6 /* namespaceURI */]] || HTML_NAMESPACE;
            var localName = strings[skeleton[1 /* localOrNodeName */]];
            var _constructor = NS_NAME_TO_CLASS["".concat(namespaceURI, ":").concat(localName)] || HTMLElement;
            var node = new _constructor(1 /* ELEMENT_NODE */, localName, namespaceURI, this, skeleton[7 /* index */]);
            (skeleton[2 /* attributes */] || []).forEach(function (attribute) {
              return (
            ...
            (skeleton[4 /* childNodes */] || []).forEach(function (child) {
              return node.appendChild(_this2[64 /* hydrateNode */](strings, child));
            });
            return node;
        }
      }
      ...
      value: function getElementById(id) {
        var el = _matchChildElement(this.head, function (element) {
          return element.id === id;
        });
        if (el) {
          return el;
        }
        return _matchChildElement(this.body, function (element) {
          return element.id === id;
        });
      }
    }]);
  ...
  var HTMLHeadElement = /*#__PURE__*/function (_HTMLElement) {
    function HTMLHeadElement() {
      _classCallCheck(this, HTMLHeadElement);
      return _callSuper(this, HTMLHeadElement, arguments);
    }
  ...
  var HTMLTextAreaElement = /*#__PURE__*/function (_HTMLElement) {
    function HTMLTextAreaElement() {
      ...
      _this = _callSuper(this, HTMLTextAreaElement, [].concat(args));
      // Per spec, some attributes like 'value' and 'checked' change behavior based on dirty flags.
      // Since these flags can only be changed on interaction (outside of worker), we can ignore them here.
      // Tradeoffs: Consequent attribute changes are missing, HTMLFormElement.reset() doesn't work, etc.
      // Alternative: Implement dirty flag checking in worker-dom, which would require listening for
    ...
    _inherits(HTMLTextAreaElement, _HTMLElement);
    return _createClass(HTMLTextAreaElement, [{
      key: "value",
      get:
      // TODO(willchou): There are a few interrelated issues with `value` property.
      //   1. "Dirtiness" caveat above.
  ...
  function createStorage(document, location, data) {
    ...
    define(storage, 'setItem', {
      value: function value(key, _value) {
        ...
        transfer(document, [12 /* STORAGE */, 2 /* SET */, location, store$1(key) + 1, store$1(stringValue) + 1]);
      }
    });
    define(storage, 'removeItem', {
      value: function value(key) {
        delete this[key];
        transfer(document, [12 /* STORAGE */, 2 /* SET */, location, store$1(key) + 1, 0 // value == 0 represents deletion.
        ]);
      }
    });
    define(storage, 'clear', {
      value: function value() {
        ...
        transfer(document, [12 /* STORAGE */, 2 /* SET */, location, 0, 0 // value == 0 represents deletion.
        ]);
      }
    });
    return storage;
  ...
  function initialize(document, strings, hydrateableNode, cssKeys, globalEventHandlerKeys, _ref, localStorageInit, sessionStorageInit) {
    ...
    (hydrateableNode[4 /* childNodes */] || []).forEach(function (child) {
      return document.body.appendChild(document[64 /* hydrateNode */](strings, child));
    });
    var window = document.defaultView;
  ...
  var SVGElement = /*#__PURE__*/function (_Element) {
    function SVGElement(nodeType, localName, namespaceURI, ownerDocument) {
      ...
      _this = _callSuper(this, SVGElement, [nodeType, localName, SVG_NAMESPACE, ownerDocument]);

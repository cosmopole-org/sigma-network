var WorkerThread = (function (exports) {
    ...
    class AMP {
      ...
      getState(key = '') {
        return new Promise(resolve => {
          ...
          transfer(this.document, [12 /* STORAGE */, 1 /* GET */, 2 /* AmpState */, /* key */store(key) + 1, /* value */0]);
    ...
    function callFunctionMessageHandler(event, document) {
      ...
      if (!fn) {
        transfer(document, [13 /* FUNCTION_CALL */, 2 /* REJECT */, index, store(JSON.stringify(`[worker-dom]: Exported function "${fnIdentifier}" could not be found.`))]);
        return;
      }
      ...
      .then(f => f.apply(null, fnArguments)).then(value => {
        ...
        transfer(document, [13 /* FUNCTION_CALL */, 2 /* REJECT */, index, store(JSON.stringify(`[worker-dom]: Function "${fnIdentifier}" threw: "${errorMessage}"`))]);
      });
    }
